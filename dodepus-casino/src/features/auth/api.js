...
function humanizeAuthError(err) {
  ...
  if (/password/i.test(msg) && /weak|length|min/i.test(msg)) return 'Слабый пароль: минимум 8 символов, латинские буквы и цифра.';
  if (/rate limit|too many|over_email_send_rate_limit/i.test(msg) || code === 'over_email_send_rate_limit') return 'Слишком много попыток. Попробуйте позже.';

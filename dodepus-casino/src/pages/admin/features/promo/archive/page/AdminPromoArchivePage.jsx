...
import { PromoArchiveHeader } from '../blocks/index.js';
import { PromoCodesTable, PromoDetailsPanel } from '@/pages/admin/features/promo/list/index.js';
import {
  listAdminArchivedPromocodes,
  subscribeToAdminPromocodes,
} from '@local-sim/modules/promo/index.js';

export default function AdminPromoArchivePage() {

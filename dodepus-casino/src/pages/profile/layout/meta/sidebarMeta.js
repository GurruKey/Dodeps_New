...
export function pickProfileRankMeta(rankSummary) {
...
export function pickProfileVerificationMeta(verificationSummary = {}) {
...
export function formatProfileBalance(value, currency) {
